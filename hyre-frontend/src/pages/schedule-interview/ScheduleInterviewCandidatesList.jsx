...
export default function RecruiterScreeningCandidatesList() {
  ...
  useEffect(() => {
    ...
    axiosInstance
      .get(`/api/CandidateRounds/job/${jobId}/candidates?status=${status}`)
      .then((res) => {
                  ...
                  <TableCell align="center">
                    {activeTab === "Pending" ? (
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/dashboard/schedule-interview/${jobId}/candidate/${c.candidateID}/schedule`
                          )
                        }
                      >
                        Schedule
                      ...
                      <Button
                        ...
                        onClick={() =>
                          navigate(
                            `/dashboard/schedule-interview/${jobId}/candidate/${c.candidateID}/view`
                          )
                        }
                      >
                        View
